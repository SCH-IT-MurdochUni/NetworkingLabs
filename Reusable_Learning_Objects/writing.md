...
So here I would probably expect students to come up with things like:
...
* Diabetes
* ECG
* Pressure in the chest, neck, jaw, shoulders, back or arms or sweating, nausea, vomiting, or shortness of breath.
* Blood tests
...
* Statins 
* Heart bypass
* A product of Westernisation 

They won't get all of them, and don't force them to. The ones that I have listed overlap, and that is ok too. Let it happen organically write up whatever the do get on the board. I would then ask the students to work in groups of 4-5 to arrange these topics into a logical order. 

There are lots of different ways that we could group these. I will provide two examples below:
...
Many of the example that the students provide can exist in multiple categories. For example, the causes or lifestyle factors are also preventatives and treatments. That is ok. Within the groupings that the students came up with, for example, within Example 2: Cause, Effect, 
